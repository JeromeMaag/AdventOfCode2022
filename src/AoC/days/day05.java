...
public class day05 implements day {
    ...
    public String part1(List<String> input) {
        List<String> inputs = new ArrayList<>(input);
        int res = 0;
    ...
    public String part2(List<String> input) {
        ...
        for (String s : inputs) {
            ...
            switch (sPars[5]) {
                case "1":
                    for (int i = zwischenStack.size(); i > 0; i--) {
                        stack1.add(zwischenStack.get(zwischenStack.size() - 1));
                        zwischenStack.remove(zwischenStack.size() - 1);
                    }
                    break;
                case "2":
                    for (int i = zwischenStack.size(); i > 0; i--) {
                        stack2.add(zwischenStack.get(zwischenStack.size() - 1));
                        zwischenStack.remove(zwischenStack.size() - 1);
                    }
                    break;
                case "3":
                    for (int i = zwischenStack.size(); i > 0; i--) {
                        stack3.add(zwischenStack.get(zwischenStack.size() - 1));
                        zwischenStack.remove(zwischenStack.size() - 1);
                    }
                    break;
                case "4":
                    for (int i = zwischenStack.size(); i > 0; i--) {
                        stack4.add(zwischenStack.get(zwischenStack.size() - 1));
                        zwischenStack.remove(zwischenStack.size() - 1);
                    }
                    break;
                case "5":
                    for (int i = zwischenStack.size(); i > 0; i--) {
                        stack5.add(zwischenStack.get(zwischenStack.size() - 1));
                        zwischenStack.remove(zwischenStack.size() - 1);
                    }
                    break;
                case "6":
                    for (int i = zwischenStack.size(); i > 0; i--) {
                        stack6.add(zwischenStack.get(zwischenStack.size() - 1));
                        zwischenStack.remove(zwischenStack.size() - 1);
                    }
                    break;
                case "7":
                    for (int i = zwischenStack.size(); i > 0; i--) {
                        stack7.add(zwischenStack.get(zwischenStack.size() - 1));
                        zwischenStack.remove(zwischenStack.size() - 1);
                    }
                    break;
                case "8":
                    for (int i = zwischenStack.size(); i > 0; i--) {
                        stack8.add(zwischenStack.get(zwischenStack.size() - 1));
                        zwischenStack.remove(zwischenStack.size() - 1);
                    }
                    break;
                case "9":
                    for (int i = zwischenStack.size(); i > 0; i--) {
                        stack9.add(zwischenStack.get(zwischenStack.size() - 1));
                        zwischenStack.remove(zwischenStack.size() - 1);
                    }
                    break;
